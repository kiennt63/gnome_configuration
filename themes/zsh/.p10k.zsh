# Generated by Powerlevel10k configuration wizard on 2021-10-20 at 02:14 +07.
...
# disconnected, no frame, compact, concise, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  # good value 189
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=183 #76
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=203
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='ツ'
